...
./on-tools/manifest-build-tools/HWIMO-BUILD on-tools/manifest-build-tools/application/release_debian_packages.py --build-directory b/ \
        ...
        --artifactory-subject rackhd \
        --artifactory-repo debian \
        --artifactory-component main \
        --artifactory-distribution trusty \
        --artifactory-architecture amd64 \
        --debian-depth 3
        ...
        artifactory-credential: The environment variable name of artifactory credential.
                            ...
                            artifactory-subject: The Artifactory subject, which is either a user or an organization
                            artifactory-repo: The Artifactory repository name
...
def main():
    ...
    try:
        artifactory_obj = JFrogArtifactory(
                                             ...
                                             artifactory_loc= "https://roebling.hwimo.lab.emc.com/artifactory" )
